# Incident Report: INC-0275F76CBDF0
...
## Brute Force Attack from 185.156.73.54 targeting 3 hosts (multi-stage: initial_access → impact)

### Executive Summary

A critical-severity incident was detected involving repeated authentication attempts using common or dictionary-based credentials to gain unauthorized access. The activity originated from 185.156.73.54 and targeted 3 internal hosts over a period of 38 minutes. A total of 3 related events were correlated into this incident. The attack follows a multi-stage pattern (Initial Access → Impact), indicating a coordinated and potentially advanced threat.

### Timeline

**2026-09-23T03:34:00** — FTP-Patator detected from 185.156.73.54 to 192.168.1.25:3306 (category: brute_force)

**2026-09-23T04:02:00** — DoS Hulk detected from 185.156.73.54 to 192.168.1.50:80 (category: dos)

**2026-09-23T04:12:00** — DDoS detected from 185.156.73.54 to 192.168.1.10:8080 (category: ddos)
...
**Affected assets:** 192.168.1.25, 192.168.1.50, 192.168.1.10

**Target ports:** 3306, 80, 8080

### Technical Details

**Attack vectors observed:** Brute Force, Dos, Ddos
...
`T1110 - Brute Force`, `T1110.001 - Password Guessing`, `T1499 - Endpoint Denial of Service`, `T1498 - Network Denial of Service`, `T1498.001 - Direct Network Flood`

---

*Report generated by SOC Log Analyzer | 3 events analyzed | Duration: 38m 0s*