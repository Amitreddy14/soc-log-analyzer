# Incident Report: INC-8AD01C716B8B
...
## DoS Attack from 91.240.118.172 targeting 5 hosts (multi-stage: impact → initial_access → persistence)

### Executive Summary

A critical-severity incident was detected involving denial of service attack targeting service availability. The activity originated from 91.240.118.172 and targeted 5 internal hosts over a period of 51 minutes. A total of 12 related events were correlated into this incident. The attack follows a multi-stage pattern (Impact → Initial Access → Persistence), indicating a coordinated and potentially advanced threat.

### Timeline

**2026-09-22T05:01:00** — DoS Hulk detected from 91.240.118.172 to 10.0.0.5:80 (category: dos)

**2026-09-22T05:03:00** — Web Attack Brute Force detected from 91.240.118.172 to 10.0.0.12:443 (category: web_attack_bruteforce)

**2026-09-22T05:06:00** — DDoS detected from 91.240.118.172 to 192.168.1.50:21 (category: ddos)

**2026-09-22T05:17:00** — Bot detected from 91.240.118.172 to 192.168.1.25:53 (category: botnet)

**2026-09-22T05:19:00** — FTP-Patator detected from 91.240.118.172 to 192.168.1.25:80 (category: brute_force)
...
**Affected assets:** 10.0.0.5, 10.0.0.12, 192.168.1.50, 192.168.1.25, 192.168.1.10

**Target ports:** 80, 443, 21, 53, 3306, 3389

### Technical Details

**Attack vectors observed:** Dos, Web Attack Bruteforce, Ddos, Botnet, Brute Force

**Kill chain progression:** Impact → Initial Access → Persistence
...
`T1499 - Endpoint Denial of Service`, `T1110 - Brute Force`, `T1190 - Exploit Public-Facing Application`, `T1498 - Network Denial of Service`, `T1498.001 - Direct Network Flood`, `T1583.005 - Botnet`, `T1071 - Application Layer Protocol`, `T1110.001 - Password Guessing`

---

*Report generated by SOC Log Analyzer | 12 events analyzed | Duration: 51m 38s*