# Incident Report: INC-7D9AAAB33461
...
A critical-severity incident was detected involving systematic network reconnaissance to identify open services and potential entry points. The activity originated from 185.220.101.1 and targeted 5 internal hosts over a period of 41 minutes. A total of 9 related events were correlated into this incident. The attack follows a multi-stage pattern (Reconnaissance → Initial Access → Impact → Execution → Persistence), indicating a coordinated and potentially advanced threat.

### Timeline

**2026-09-22T17:42:00** — PortScan detected from 185.220.101.1 to 192.168.1.50:53 (category: port_scan)

**2026-09-22T17:46:00** — SSH-Patator detected from 185.220.101.1 to 192.168.1.50:8080 (category: brute_force)

**2026-09-22T17:51:00** — DDoS detected from 185.220.101.1 to 192.168.1.50:80 (category: ddos)

**2026-09-22T17:59:00** — PortScan detected from 185.220.101.1 to 192.168.1.10:21 (category: port_scan)

**2026-09-22T18:01:00** — PortScan detected from 185.220.101.1 to 192.168.1.25:22 (category: port_scan)


The incident spanned 41 minutes with an average rate of 0.2 events per minute.
...
**Target ports:** 53, 8080, 80, 21, 22

### Technical Details

**Attack vectors observed:** Port Scan, Brute Force, Ddos, Web Attack Xss, Dos, Botnet

**Kill chain progression:** Reconnaissance → Initial Access → Impact → Execution → Persistence
...
`T1046 - Network Service Discovery`, `T1110 - Brute Force`, `T1110.001 - Password Guessing`, `T1498 - Network Denial of Service`, `T1498.001 - Direct Network Flood`, `T1059.007 - JavaScript`, `T1189 - Drive-by Compromise`, `T1499 - Endpoint Denial of Service`, `T1583.005 - Botnet`, `T1071 - Application Layer Protocol`

---

*Report generated by SOC Log Analyzer | 9 events analyzed | Duration: 41m 0s*