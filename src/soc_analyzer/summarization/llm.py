...
Uses OpenAI or Anthropic APIs to generate natural language incident reports
that are significantly more nuanced, contextual, and readable than templates.

Falls back to template-based summarization if:
